...
<nav class="navbar" id="navbar">
    <div class="navbar__inner">
        ...
        <div class="navbar__links">
            ...
            <a href="/#program" class="navbar__cta">Bergabung</a>
        </div>
    ...
    <div class="navbar__mobile" id="navbarMobile">
        <div class="navbar__mobile-inner">
            ...
            <a href="/#program" class="navbar__mobile-cta">Bergabung</a>
        </div>
    </div>
</nav>
...
<div style="flex: 1; min-width: 300px; display: flex; justify-content: center; align-items: center; position: relative; padding: 20px;">
    ...
    <!-- Gambar Utama (Ganti src dengan file PNG Anda) -->
    ...
    <!-- Badge 1: 47 Agen (Posisi Kiri Atas) -->
    <div class="hero__float-badge hero__float-badge--0" style="--float-delay: 0.0s; position: absolute; top: 10%; left: 0; z-index: 2; background: white; padding: 12px 20px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); display: flex; align-items: center; gap: 12px; transform: translateX(-20px);">
        ...
        <div class="hero__float-text">
            <p class="hero__float-label" style="margin: 0; font-weight: 800; color: #0f172a; font-size: 16px;">47 Agen</p>
            <p class="hero__float-sub" style="margin: 0; font-size: 12px; color: #64748b;">Perubahan</p>
        </div>
    </div>

    <!-- Badge 2: 12 Program (Posisi Kanan Tengah) -->
    <div class="hero__float-badge hero__float-badge--1" style="--float-delay: 1.1s; position: absolute; top: 15%; right: -20px; z-index: 2; background: white; padding: 12px 20px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); display: flex; align-items: center; gap: 12px; transform: translateY(-50%);">
        ...
        <div class="hero__float-text">
            <p class="hero__float-label" style="margin: 0; font-weight: 800; color: #0f172a; font-size: 16px;">2 Program</p>
            <p class="hero__float-sub" style="margin: 0; font-size: 12px; color: #64748b;">Aktif 2026</p>
        </div>
    </div>
    ...
    <div class="hero__float-badge hero__float-badge--2" style="--float-delay: 2.2s; position: absolute; bottom: 20%; left: -3%; z-index: 2; background: white; padding: 12px 20px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.08); display: flex; align-items: center; gap: 12px; transform: translateX(-10px);">
        ...
        <div class="hero__float-text">
            <p class="hero__float-label" style="margin: 0; font-weight: 800; color: #0f172a; font-size: 16px;">3+ Tahun</p>
            <p class="hero__float-sub" style="margin: 0; font-size: 12px; color: #64748b;">Berdampak</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="about__grid">
            <div class="about__text reveal" data-anim="fade-right">
                ...
                <p class="about__paragraph">Change Agent Network (CAN) adalah komunitas agen perubahan BPS Provinsi Aceh yang lahir dari semangat transformasi dan komitmen untuk menghadirkan pelayanan statistik berkualitas tinggi bagi masyarakat Aceh.</p>
                <p class="about__paragraph">Berdiri sejak 2023, CAN telah menjadi motor penggerak inovasi internal yang mensinergikan program-program unggulan demi mewujudkan BPS Provinsi Aceh yang adaptif, akuntabel, dan berorientasi pada dampak nyata.</p>
                <div class="about__box about__box--visi"><span class="about__box-badge" style="background-color:#1E3A5F;">Visi</span><p class="about__box-text">Menjadi komunitas agen perubahan terdepan yang mengakselerasi transformasi BPS Provinsi Aceh menuju instansi statistik berkelas dunia.</p></div>
                <div class="about__box about__box--misi"><span class="about__box-badge" style="background-color:#16A34A;">Misi</span><ul class="about__misi-list"><li><svg class="icon-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color:#16A34A;"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg><span>Mendorong budaya inovasi dan pelayanan prima di lingkungan BPS Aceh</span></li><li><svg class="icon-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color:#16A34A;"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg><span>Mempercepat transformasi digital layanan statistik berbasis data</span></li><li><svg class="icon-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="color:#16A34A;"><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"></path><polyline points="9 12 11 14 15 10"></polyline></svg><span>Membangun ekosistem kolaborasi antar pegawai yang berdampak nyata</span></li></ul></div>
            </div>
        ...
        <div class="stat-card reveal" data-anim="fade-up" data-delay="0.0">
            ...
            <div class="stat-card__value count-up" data-target="47" data-suffix="" style="color:#F97316;">0</div>
            <p class="stat-card__label">Agen Perubahan</p>
        </div>
        <div class="stat-card reveal" data-anim="fade-up" data-delay="0.1">
            ...
            <div class="stat-card__value count-up" data-target="2" data-suffix="" style="color:#0D9488;">0</div>
            <p class="stat-card__label">Program Aktif</p>
        </div>
        <div class="stat-card reveal" data-anim="fade-up" data-delay="0.2">
            ...
            <div class="stat-card__value count-up" data-target="3" data-suffix="+" style="color:#1E3A5F;">0+</div>
            <p class="stat-card__label">Tahun Aktif</p>
        </div>
...
<section id="core" class="values">
    <div class="container">
        ...
        <div class="value-card reveal" data-anim="fade-up" data-delay="0.0">
            ...
            <span class="value-card__subtitle" style="color:#F97316;">Service First</span>
        ...
        <div class="value-card reveal" data-anim="fade-up" data-delay="0.1">
            ...
            <span class="value-card__subtitle" style="color:#1E3A5F;">Accountable</span>
        ...
        <div class="value-card reveal" data-anim="fade-up" data-delay="0.2">
            ...
            <span class="value-card__subtitle" style="color:#16A34A;">Competent</span>
        ...
        <div class="value-card reveal" data-anim="fade-up" data-delay="0.30000000000000004">
            ...
            <span class="value-card__subtitle" style="color:#0D9488;">Harmonious</span>
            ...
            <span class="value-card__subtitle" style="color:#0A008F;">Loyal</span>
            ...
            <span class="value-card__subtitle" style="color:#FACC15;">Adaptive</span>
            ...
            <span class="value-card__subtitle" style="color:#DC2626;">Collaborative</span>
    ...
    <div class="container">
        ...
        <div class="program-card reveal" data-anim="fade-up" data-delay="0.0">
            ...
            <div class="program-card__body">
                ...
                <button class="btn-outline" style="--accent:#F97316;">Selengkapnya <svg class="icon-svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
            </div>
        </div>
        <div class="program-card reveal" data-anim="fade-up" data-delay="0.1">
            ...
            <div class="program-card__body">
                ...
                <button class="btn-outline" style="--accent:#0D9488;">Selengkapnya <svg class="icon-svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
            </div>
        </div>
        <div class="program-card reveal" data-anim="fade-up" data-delay="0.2">
            ...
            <div class="program-card__body">
                ...
                <button class="btn-outline" style="--accent:#16A34A;">Selengkapnya <svg class="icon-svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
            </div>
        </div></div>
        <div class="programs__sublabel reveal" data-anim="fade-right"><span class="programs__sublabel-bar" style="background-color:#1E3A5F;"></span><span class="programs__sublabel-text">Rencana Aksi Daerah</span></div>
        ...
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.0">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">Gema Rasa</h4><p class="rad-card__subtitle">Bergerak, Bersama, Berasakan</p></div>
            </div>
            <p class="rad-card__desc">Gerakan membangun kebersamaan dan sinergi aktif pegawai melalui berbagai kegiatan yang bermakna.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#FFF7ED; color:#F97316;">Do-it Day</span><span class="rad-card__tag" style="background-color:#FFF7ED; color:#F97316;">Greetings</span><span class="rad-card__tag" style="background-color:#FFF7ED; color:#F97316;">100 Voice</span></div>
            <button class="rad-card__link" style="color:#F97316;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div>
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.08">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">Knowledge Management System</h4><p class="rad-card__subtitle">Rekam, Kelola, Bagikan</p></div>
            </div>
            <p class="rad-card__desc">Sistem pengelolaan pengetahuan untuk mendokumentasikan dan mengoptimalkan knowledge base organisasi.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#EFF6FF; color:#1E3A5F;">Knowledge Base</span><span class="rad-card__tag" style="background-color:#EFF6FF; color:#1E3A5F;">Dokumentasi</span><span class="rad-card__tag" style="background-color:#EFF6FF; color:#1E3A5F;">Change Connect</span></div>
            <button class="rad-card__link" style="color:#1E3A5F;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div>
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.16">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">Thanks God It's Monday</h4><p class="rad-card__subtitle">Hari Baru, Pekan Baru, Pikiran Baru</p></div>
            </div>
            <p class="rad-card__desc">Program mingguan yang membangun semangat dan energi positif dalam memulai aktivitas kerja.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#FFFBEB; color:#D97706;">Morning Briefing</span><span class="rad-card__tag" style="background-color:#FFFBEB; color:#D97706;">Hura-Hura Bersama</span><span class="rad-card__tag" style="background-color:#FFFBEB; color:#D97706;">Pengumuman ShIM</span></div>
            <button class="rad-card__link" style="color:#D97706;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div>
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.24">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">Fabulous Friday</h4><p class="rad-card__subtitle">Tajam, Cerita, &amp; Apresiasi</p></div>
            </div>
            <p class="rad-card__desc">Wadah ekspresi bagi seluruh pegawai BPS Aceh untuk menyampaikan apresiasi dan merayakan pencapaian.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#FAF5FF; color:#9333EA;">Curhat Deng Hari</span><span class="rad-card__tag" style="background-color:#FAF5FF; color:#9333EA;">FIS</span><span class="rad-card__tag" style="background-color:#FAF5FF; color:#9333EA;">Pengumuman OTK</span></div>
            <button class="rad-card__link" style="color:#9333EA;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div>
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.32">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">Great Team of The Quarter</h4><p class="rad-card__subtitle">Collaborate, Accelerate</p></div>
            </div>
            <p class="rad-card__desc">Penghargaan triwulanan untuk tim terbaik yang menunjukkan kolaborasi dan inovasi luar biasa.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#F0FDFA; color:#0D9488;">Nominasi Tim</span><span class="rad-card__tag" style="background-color:#F0FDFA; color:#0D9488;">Penilaian Dampak</span><span class="rad-card__tag" style="background-color:#F0FDFA; color:#0D9488;">Apresiasi Publik</span></div>
            <button class="rad-card__link" style="color:#0D9488;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div>
        <div class="rad-card reveal" data-anim="fade-up" data-delay="0.4">
            <div class="rad-card__head">
                ...
                <div><h4 class="rad-card__title">BPS Goes To School</h4><p class="rad-card__subtitle">Edukasi, Inspirasi, Dampak</p></div>
            </div>
            <p class="rad-card__desc">Kegiatan literasi statistik ke sekolah-sekolah untuk menginspirasi generasi muda Aceh dengan data.</p>
            <div class="rad-card__tags"><span class="rad-card__tag" style="background-color:#F0FDF4; color:#16A34A;">Kunjungan Sekolah</span><span class="rad-card__tag" style="background-color:#F0FDF4; color:#16A34A;">Workshop Statistik</span><span class="rad-card__tag" style="background-color:#F0FDF4; color:#16A34A;">Data Storytelling</span></div>
            <button class="rad-card__link" style="color:#16A34A;">Selengkapnya <svg class="icon-svg" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg></button>
        </div></div>
    </div>
</section>
...
<div class="team__leader-wrap reveal" data-anim="scale-in">
    <div class="leader-card">
        ...
        <div class="card-popout-avatar">
            <img src="img/AgusAndria.png" alt="Agus Andria" class="card-popout-avatar__img">
            <!-- Bintang untuk Leader -->
            <div class="leader-card__star">★</div>
        </div>
        
        <h3 class="leader-card__name">Agus Andria, SST, M.Si.</h3>
...
<div class="team__grid">
    ...
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.0">
        <div class="card-popout-avatar">
            <img src="img/Wahdini.png" alt="Wahdini" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Wahdini, S.Psi.</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change Champion</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>

    <!-- Member 2: Dhani Fitri -->
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.07">
        <div class="card-popout-avatar">
            <img src="img/Dhani.png" alt="Dhani Fitri Yanthi" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Dhani Fitri Yanthi, S.Si</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ....</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>
    ...
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.14">
        <div class="card-popout-avatar">
            <img src="img/Cahya.png" alt="Cahya Danu Rahman" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Cahya Danu Rahman, SST, M.Ec.Dev.</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>
    ...
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.21000000000000002">
        <div class="card-popout-avatar">
            <img src="img/Kanasha.png" alt="Kanasha Humaira" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Kanasha Humaira, SST</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>
    ...
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.28">
        <div class="card-popout-avatar">
            <img src="img/Zahlul.png" alt="Zahlul Fuadi" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Zahlul Fuadi, S.Tr.Stat.</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bidang Statistik Produksi</p>
    </div>

    <!-- Member 6: Naura Shada -->
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.35000000000000003">
        <div class="card-popout-avatar">
            <img src="img/Naura.png" alt="Naura Shada" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Naura Shada Kirana, S.Tr.Stat.</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bagian Umum</p>
    </div>

    <!-- Member 7: Farhan -->
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.42000000000000004">
        <div class="card-popout-avatar">
            <img src="img/Farhan.png" alt="Farhan" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Farhan</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>
    ...
    <div class="member-card reveal" data-anim="fade-up" data-delay="0.49000000000000005">
        <div class="card-popout-avatar">
            <img src="img/Sinta.png" alt="Sinta Nuriyah" class="card-popout-avatar__img">
        </div>
        <h4 class="member-card__name">Sinta Nuriyah, S.Tr.Stat.</h4>
        <p class="member-card__title">...</p>
        <span class="member-card__role">Change ...</span>
        <p class="member-card__unit">Bidang ...</p>
    </div>
    ...
    <div class="container">
        ...
        <div class="news__grid">
            @forelse($beritaList as $item)
                @php
                    // 1. Ambil kategori (Sesuaikan key 'category' dengan field dari API BPS)
                    $category = $item['category'] ?? 'Kegiatan'; 
                    
                    // 2. Mapping warna & ikon otomatis agar tetap konsisten dengan desain Anda
                    switch($category) {
                        case 'Inspirasi':
                            $color = '#16A34A';
                    ...
                    // 3. Efek animasi berurutan (0.0, 0.1, 0.2) menggunakan sisa bagi indeks loop
    ...
    <div class="container">
        <div class="footer__grid">
            <div>
                ...
                <div class="footer__can"><span class="footer__can-pill">CAN</span><span class="footer__can-text">Change Agent Network</span></div>
                <p class="footer__desc">Komunitas agen perubahan BPS Provinsi Aceh yang berdedikasi membangun budaya inovasi dan meningkatkan kualitas pelayanan statistik.</p>
                <p class="footer__tagline">Berani Berubah, Berani Berdampak</p>
            ...
            <div>
                ...
                <div class="footer__sub-section">
                    <p class="footer__col-title">Program</p>
                    <ul class="footer__links">
                        <li><a href="#program"><span class="dot"></span>Duta S3</a></li>
                        <li><a href="#program"><span class="dot"></span>Coach Me</a></li>
                        <li><a href="#program"><span class="dot"></span>Bertumbuh</a></li>
                        <li><a href="#program"><span class="dot"></span>Gema Rasa</a></li>
                        <li><a href="#program"><span class="dot"></span>Fabulous Friday</a></li>
                    </ul>
                </div>
            </div>
            <div>
                ...
                <div class="footer__akhlak">
                    <p class="footer__akhlak-label">Bagian dari</p>
        ...
        <div class="footer__bottom">
            <p>© 2026 Change Agent Network — BPS Provinsi Aceh. All rights reserved.</p>
            <p>Berani Berubah · Berani Berdampak · BPS Aceh</p>
        </div>
    </div>
</footer>
</div>
